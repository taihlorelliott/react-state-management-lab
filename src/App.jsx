...
function App() {
  ...
  const zombieFighters = [
  {
    ...
    strength: 6,
    agility: 4,
    img: 'https://i.postimg.cc/MZPp8j7z/survivor.jpg',
  },
  {
    name: 'Scavenger',
    price: 10,
    strength: 5,
    agility: 5,
    img: 'https://i.postimg.cc/Y2sMPB79/scavenger.jpg',
  },
  {
    name: 'Shadow',
    price: 18,
    strength: 7,
    agility: 8,
    img: 'https://i.postimg.cc/nh8ZHKCf/shadow.jpg',
  },
  {
    name: 'Tracker',
    price: 14,
    strength: 7,
    agility: 6,
    img: 'https://i.postimg.cc/P5mHNLwp/tracker.jpg',
  },
  {
    name: 'Sharpshooter',
    price: 20,
    strength: 6,
    agility: 8,
    img: 'https://i.postimg.cc/76LrBmQ0/sharpshooter.jpg',
  },
  {
    name: 'Medic',
    price: 15,
    strength: 5,
    agility: 7,
    img: 'https://i.postimg.cc/DZYkRLtD/medic.jpg',
  },
  {
    name: 'Engineer',
    price: 16,
    strength: 6,
    agility: 5,
    img: 'https://i.postimg.cc/6qkspw6f/engineer.jpg',
  },
  {
    name: 'Brawler',
    price: 11,
    strength: 8,
    agility: 3,
    img: 'https://i.postimg.cc/TPRzwtxF/brawler.jpg',
  },
  {
    name: 'Infiltrator',
    price: 17,
    strength: 5,
    agility: 9,
    img: 'https://i.postimg.cc/nLSnfym0/infultrator.jpg',
  },
  {
    name: 'Leader',
    price: 22,
    strength: 7,
    agility: 6,
    img: 'https://i.postimg.cc/WzgVrtHH/leader.jpg',
  },
];
